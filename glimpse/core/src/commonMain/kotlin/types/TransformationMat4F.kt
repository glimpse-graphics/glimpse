 ...
 */
fun translation(vector: Vec3<Float>): Mat4<Float> {
    val (x, y, z) = vector
    return Mat4(
        listOf(
            1f, 0f, 0f, 0f,
 ...
 */
fun rotation(axis: Vec3<Float>, angle: Angle<Float>): Mat4<Float> {
 ...
 */
fun rotationX(angle: Angle<Float>): Mat4<Float> {
    val sin = sin(angle)
    val cos = cos(angle)
    return Mat4(
        listOf(
 ...
 */
fun rotationY(angle: Angle<Float>): Mat4<Float> {
    val sin = sin(angle)
    val cos = cos(angle)
    return Mat4(
        listOf(
 ...
 */
fun rotationZ(angle: Angle<Float>): Mat4<Float> {
    val sin = sin(angle)
    val cos = cos(angle)
    return Mat4(
        listOf(
 ...
 */
fun scale(scale: Float): Mat4<Float> = scale(scale, scale, scale)

/**
 * Creates a transformation matrix for scaling by a given scale in [x], [y] and [z] directions.
 */
fun scale(x: Float = 1f, y: Float = 1f, z: Float = 1f): Mat4<Float> =
    Mat4(
        listOf(
            x, 0f, 0f, 0f,
            0f, y, 0f, 0f,
 ...
 */
fun mirror(normal: Vec3<Float>, origin: Vec3<Float>): Mat4<Float> {
