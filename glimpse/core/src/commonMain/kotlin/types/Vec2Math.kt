...
fun <T> magnitude(vector: Vec2<T>): T where T : Number, T : Comparable<T> = vector.magnitude()
...
fun <T> normalize(vector: Vec2<T>): Vec2<T> where T : Number, T : Comparable<T> = vector / vector.magnitude()
