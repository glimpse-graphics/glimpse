...
actual class GlimpseAdapter {
    ...
    actual fun glCullFace(faceCullingMode: FaceCullingMode) {
        ...
        faceCullingMode.toInt()?.let { mode -> GLES20.glCullFace(mode) }
    }
    ...
    actual fun glGenFramebuffers(framebufferHandles: IntArray) {
        GLES20.glGenFramebuffers(framebufferHandles.size, framebufferHandles, 0)
    }
    ...
    actual fun glCheckFramebufferStatus(): FramebufferStatus =
        framebufferStatusOf(GLES20.glCheckFramebufferStatus(GLES20.GL_FRAMEBUFFER))
    ...
    private fun framebufferStatusOf(value: Int): FramebufferStatus = when (value) {
        ...
        GLES20.GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT -> FramebufferStatus.INCOMPLETE_ATTACHMENT
    ...
    actual fun glDeleteFramebuffers(framebufferHandles: IntArray) {
        GLES20.glDeleteFramebuffers(framebufferHandles.size, framebufferHandles, 0)
    }
    ...
    actual fun glGenRenderbuffers(renderbufferHandles: IntArray) {
        GLES20.glGenRenderbuffers(renderbufferHandles.size, renderbufferHandles, 0)
    }
    ...
    actual fun glRenderbufferStorage(internalFormat: TextureInternalFormat, width: Int, height: Int) {
        GLES20.glRenderbufferStorage(GLES20.GL_RENDERBUFFER, internalFormat.toInt(), width, height)
    }
    ...
    actual fun glDeleteRenderbuffers(renderbufferHandles: IntArray) {
        GLES20.glDeleteRenderbuffers(renderbufferHandles.size, renderbufferHandles, 0)
    }
    ...
    private fun TexturePixelType.toInt(): Int = when (this) {
        TexturePixelType.UNSIGNED_BYTE -> GLES20.GL_UNSIGNED_BYTE
        TexturePixelType.BYTE -> GLES20.GL_BYTE
        TexturePixelType.UNSIGNED_SHORT -> GLES20.GL_UNSIGNED_SHORT
    ...
    actual fun glUniform(location: Int, buffer: IntUniformBuffer) {
        ...
        when (buffer.elementType) {
            UniformBufferDataElementType.NUMBER ->
                GLES20.glUniform1iv(location, elementsCount, buffer.data.nioBuffer)
            UniformBufferDataElementType.VEC2 ->
                GLES20.glUniform2iv(location, elementsCount, buffer.data.nioBuffer)
            UniformBufferDataElementType.VEC3 ->
                GLES20.glUniform3iv(location, elementsCount, buffer.data.nioBuffer)
            UniformBufferDataElementType.VEC4 ->
                GLES20.glUniform4iv(location, elementsCount, buffer.data.nioBuffer)
    ...
    actual fun glUniform(location: Int, buffer: FloatUniformBuffer) {
        ...
        when (buffer.elementType) {
            UniformBufferDataElementType.NUMBER ->
                GLES20.glUniform1fv(location, elementsCount, buffer.data.nioBuffer)
            UniformBufferDataElementType.VEC2 ->
                GLES20.glUniform2fv(location, elementsCount, buffer.data.nioBuffer)
            UniformBufferDataElementType.VEC3 ->
                GLES20.glUniform3fv(location, elementsCount, buffer.data.nioBuffer)
            UniformBufferDataElementType.VEC4 ->
                GLES20.glUniform4fv(location, elementsCount, buffer.data.nioBuffer)
            UniformBufferDataElementType.MAT2 ->
                GLES20.glUniformMatrix2fv(location, elementsCount, false, buffer.data.nioBuffer)
            UniformBufferDataElementType.MAT3 ->
                GLES20.glUniformMatrix3fv(location, elementsCount, false, buffer.data.nioBuffer)
            UniformBufferDataElementType.MAT4 ->
                GLES20.glUniformMatrix4fv(location, elementsCount, false, buffer.data.nioBuffer)
        }
    }
