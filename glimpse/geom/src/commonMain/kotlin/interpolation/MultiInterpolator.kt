 ...
 * @since v2.0.0
 */
interface MultiInterpolator<T, R> : Interpolator<T, R> where T : Number, T : Comparable<T> {
     ...
     */
    override val startValue: R get() = values.first()

    /**
     * Key value of this interpolator at parameter 1.
     */
    override val endValue: R get() = values.last()
}
